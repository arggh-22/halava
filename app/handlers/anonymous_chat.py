...
async def confirm_contact_share(callback: CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        print(f"[CONTACT_SHARE] Customer {callback.from_user.id} confirmed contact share for worker {worker_id}, abs {abs_id}")
...
async def decline_contact_share(callback: CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        print(f"[CONTACT_SHARE] Customer {callback.from_user.id} declined contact share for worker {worker_id}, abs {abs_id}")
...
async def offer_contact_share(callback: CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        print(f"[CONTACT_OFFER] Customer {callback.from_user.id} offers contact share for worker {worker_id}, abs {abs_id}")
...
async def accept_contact_offer(callback: CallbackQuery, state: FSMContext):
    ...
    try:
        ...
        has_unlimited = worker.unlimited_contacts_until and datetime.now() < datetime.fromisoformat(worker.unlimited_contacts_until)
