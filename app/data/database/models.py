...
class WorkerRank:
    ...
    def get_rank_description(self) -> str:
        ...
        description = (
            f"<b>Ваш ранг:</b> {rank_emoji} {rank_name}\n"
            f"<b>Выполнено заказов за 30 дней:</b> {orders}\n\n"
            "🔹 <b>Уровни рангов</b>\n\n"
            "🥉 <b>Бронза</b> — 0–2 заказа\n"
            "Доступно 1 направление для получения заказов.\n\n"
            "🥈 <b>Серебро</b> — 3–4 заказа\n"
            "Можно выбрать до 5 направлений.\n\n"
            "🥇 <b>Золото</b> — 5–9 заказов\n"
            "Можно выбрать до 10 направлений, приоритет выше.\n\n"
            "💎 <b>Платина</b> — 10+ заказов\n"
